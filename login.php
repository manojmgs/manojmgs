  ...
  <div class="appContent1">
    ...
    <form action="#" id="loginForm" method="post" class="card-body" autocomplete="off">
      ...
      <div class="text-center mt-3">
        ...
        <a href="forgot-password" class="btn btn-light">Resset Password</a>
        </div>
      </div>
    </form>
  </div>
...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4909621897215956"
